...
> Independent third-party companion app — not affiliated with, endorsed by, or sponsored by the yoRadio firmware project or its authors. All trademarks are property of their respective owners.
...
© 2026 Marcin Ożóg. All rights reserved.

This application is distributed via Google Play. Source code is proprietary
and not publicly available. This repository is used for documentation,
screenshots, and issue tracking only.

The screenshots, documentation text, and other content in this repository
are provided for informational purposes about the published application.
